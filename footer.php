<div class="bottom-navigation-bar">
    <div class="tf-container">
        <ul class="tf-navigation-bar">
            <li class="active"><a class="fw_6 d-flex justify-content-center align-items-center flex-column text-white" href="index.php"><i class="icon-home2"></i> Home</a> </li>
            <li><a class="fw_4 d-flex justify-content-center align-items-center flex-column" href="transactions.php"><i class="icon-history"></i> History</a> </li>
            <li><a class="fw_4 d-flex justify-content-center align-items-center flex-column" href="cards.php"><i class="bx bx-credit-card-alt" style="font-size:30px;"></i> My Cards</a> </li>
        ...
        <div class="panel-body">
            <div class="tf-container">
                <div class="box-content">
                    ...
                    <ul class="box-nav">
                        <li class="nav-title">More Options</li>
                        <li>
                        ...
                        <li>
                            <a href="beneficiaries.php" class="nav-link">
                        ...
                        <li>
                            <a href="mailto:techcaesar001@gmail.com" class="nav-link">
                        ...
                        <li>
                            <a href="auth.php?logout=true" class="nav-link">
