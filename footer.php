<div class="bottom-navigation-bar">
    <div class="tf-container">
        <ul class="tf-navigation-bar">
            <li class="active"><a class="fw_6 d-flex justify-content-center align-items-center flex-column text-white" href="index"><i class="icon-home2"></i> Home</a> </li>
            <li><a class="fw_4 d-flex justify-content-center align-items-center flex-column" href="transactions"><i class="icon-history"></i> History</a> </li>
            <li><a class="fw_4 d-flex justify-content-center align-items-center flex-column" href="cards"><i class="bx bx-credit-card-alt" style="font-size:30px;"></i> My Cards</a> </li>
            <li><a class="fw_4 d-flex justify-content-center align-items-center flex-column" href="spin"><svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    Rewards</a> </li>
            <li><a class="fw_4 d-flex justify-content-center align-items-center flex-column" href="profile"><i class="icon-user-outline"></i> Profile</a> </li>
        </ul>
                    ...
                    <ul class="box-nav">
                        ...
                        <li>
                            <a href="fund" class="nav-link">
                                <i class='bx bxs-arrow-to-top icon'></i>

                                <span>Fund Wallet</span>
                            </a>
                        </li>
                        <li>
                            <a href="spin" class="nav-link">
                        ...
                        <li>
                            <a href="withdraw" class="nav-link">
                                <i class='bx bxs-arrow-to-bottom icon'></i>
                        ...
                        <li>
                            <a href="portifolios" class="nav-link">
                        ...
                        <li>
                            <a href="mailto:support@ctcreditconnect.com" class="nav-link">
                        ...
                        <li>
                            <a href="auth?logout=true" class="nav-link">
