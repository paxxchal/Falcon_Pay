                    ...
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center">
                            <a href="index.php" class="app-brand-link gap-2">
                                ...
                                <span class="app-brand-text demo text-white fw-bolder">Falcon Pay</span>
                            </a>
                        </div>
                        <!-- /Logo -->

                        <p class="mb-4">Welcome <?php echo $username; ?></p>
                        <p class="text-white">Your account is under review. you will be contacted once it's ready</p>
                        <p>
                            <a href="login.php">
...
if ($_POST) {
    ...
    if ($newpassword == $cpassword) {
        ...
        if ($update) {
            ...
            $nextstep = 'https://BullfxfinanceTrading.com/signin.php?reset=true';
