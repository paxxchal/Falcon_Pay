  ...
  <div class="my-4 py-4">
          ...
          <div class="card-body">
            <form id="formAccountSettings" method="POST" onsubmit="return true" enctype="multipart/form-data">
              <div class="d-flex align-items-start align-items-sm-center gap-4">
                <img src='<?php echo $image; ?>' alt="user-avatar" class="d-block rounded" height="80px" width="80px" id="uploadedAvatar" />
                <div class="button-wrapper">
                  <label for="upload" class="btn btn-primary me-2 mb-4" tabindex="0">
                    <span class="d-none d-sm-block">Upload new photo</span>
                    <i class="bx bx-upload d-block d-sm-none"></i>
                    <input type="file" id="upload" class="account-file-input" hidden accept="image/png, image/jpeg" name="fileToUpload" />
                  </label>
              ...
              <div class="row">
                <div class="mb-3 col-md-6">
                  ...
                  <input class="form-control" type="text" id="fullname" name="username" value=<?php echo $username; ?> />
                </div>
                <div class="mb-3 col-md-6">
                ...
                <div class="mb-3 col-md-6">
                  ...
                  <input class="form-control" type="text" id="email" name="email" value='<?php echo $email; ?>' placeholder="john.doe@example.com" readonly />
                </div>
                ...
                <div class="mb-3 col-md-6">
                  ...
                  <div class="input-group input-group-merge">
                    ...
                    <input type="text" id="phoneNumber" name="phone" class="form-control" placeholder="202 555 0111" value='<?php echo $phone; ?>' />
                  </div>
                </div>
                <div class="mb-3 col-md-6">
                ...
                <div class="mb-3 col-md-6">
                  ...
                  <input type="text" class="form-control" id="zipCode" name="zip" placeholder="231465" maxlength="6" value='<?php echo $zip; ?>' />
                </div>
    ...
    <div class="appFooter">
      <div class="footer-title">
        Copyright © Falcon Pay 2024. All Rights Reserved.
      </div>
