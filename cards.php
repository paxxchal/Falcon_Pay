    ...
    <div id="appCapsule">
        ...
        <div class="card2 my-4">
            <div class="card-inner2">
                ...
                echo 'secure';
                }elseif($card_type=='quantum-pay-card'){ echo 'quantum';}
                elseif($card_type=='horizon-swift-card'){echo 'horizon';}
                elseif($card_type=='saphire-wave-card'){echo 'saphire';}
                elseif($card_type=='elite-link-card'){echo 'elite';}
                ?>" >
                ...
                <div class="back <?php if($card_type=='master-card' || $card_type=='world-elite-master-card'){echo 'master';}else{ echo 'visa';} ?>">
